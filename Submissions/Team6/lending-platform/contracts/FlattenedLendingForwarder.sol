...
library Math {
    ...
    function mulDiv(uint256 x, uint256 y, uint256 denominator) internal pure returns (uint256 result) {
        unchecked {
            // 512-bit multiply [prod1 prod0] = x * y. Compute the product mod 2┬▓Γü╡Γü╢ and mod 2┬▓Γü╡Γü╢ - 1, then use
            // the Chinese Remainder Theorem to reconstruct the 512 bit result. The result is stored in two 256
            // variables such that product = prod1 * 2┬▓Γü╡Γü╢ + prod0.
            ...
            // less than 2┬▓Γü╡Γü╢, this is the final result. We don't need to compute the high bits of the result and prod1
...
// File contracts/LendingForwarder.sol
